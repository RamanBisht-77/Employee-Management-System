...
const AllTask = () =>{
    ...
    return (
        <div className='bg-[#1c1c1c] rounded p-5 mt-5'>
             <div className='bg-gray-900 mb-2 py-2 px-4 rounded flex justify-between'>
            ...
            <div className="h-[80%] overflow-auto">
                ...
                <h2  className="text-lg font-medium w-1/5 bg-amber-700">{ele.firstName}</h2>
                <h3  className="text-lg font-medium w-1/5 bg-blue-500">{ele.taskCounts.newTask}</h3>
                <h5  className="text-lg font-medium w-1/5 bg-yellow-500">{ele.taskCounts.active}</h5>
                <h5  className="text-lg font-medium w-1/5 bg-green-700">{ele.taskCounts.completed}</h5>
                <h5  className="text-lg font-medium w-1/5 bg-red-700">{ele.taskCounts.failed}</h5>
            </div>
            })}
            </div>
         </div>
