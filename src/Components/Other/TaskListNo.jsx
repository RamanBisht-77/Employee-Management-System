...
const TaskListNo = ({ employeeData }) => {
  ...
  return (
    <div className="flex mt-10 justify-between gap-5 screen">
      ...
      <div className="w-[45%] rounded-xl py-6 px-9 bg-red-500">
      ...
      <div className="w-[45%] rounded-xl py-6 px-9 bg-blue-500">
        <h2 className="text-3xl font-semibold">
      ...
      <div className="w-[45%] rounded-xl py-6 px-9 bg-green-500">
        <h2 className="text-3xl font-semibold">
      ...
      <div className="w-[45%] rounded-xl py-6 px-9 bg-pink-500">
        <h2 className="text-3xl font-semibold">
